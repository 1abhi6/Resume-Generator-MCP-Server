...
from src.schema import ResumeSchema
...
class Response:
    def __init__(self):
        self.openai_instance = OpenAI_LLM()
        model = self.openai_instance.get_model()
        self.structured_model = model.with_structured_output(ResumeSchema)

    def get_structured_response(self, user_input: str):
        ...
        chain = prompt_template | self.structured_model
